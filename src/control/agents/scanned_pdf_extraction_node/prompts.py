...
- When slash dates are ambiguous, use the clearest locale/context visible in the scanned PDF. If the document context does not disambiguate, prefer Indian DD/MM/YYYY or DD/MM/YY.
