...
- If no week ending is present in the body or subject, set global_data.week_ending to null. Do not assume it, but still extract and preserve any row-level calendar dates that are explicitly present.
